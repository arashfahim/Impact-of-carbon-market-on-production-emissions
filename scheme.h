...
//This program solves an implicit scheme for the nonlinear HJB in https://arxiv.org/abs/2312.03665
// The implementation class contains the details of the implementation
...
struct param{//Holds the parameters of the problem
	unsigned int N_t, N_y, N_e, N_q, M;//number of intervals for y, number of intervals for e, maximum production rate
	double T, dt, dy , de, L_y, L_e , theta, gamma, mu, rho, alpha, c, constant;
