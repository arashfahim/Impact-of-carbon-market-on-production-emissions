//This is a code for solving a stochastic control problem related to the paper https://arxiv.org/abs/2312.03665
//This code is written in 2015 by Arash Fahim
// The final result is written in a dat file and the visualizations in a tex file
...
int main(){
    ...
    //Parameters preset
    p_input.M=1;
    cout << "\nMaximum poduction rate:" << p_input.M;
    p_input.N_t = 1000;
    ...
    p_input.L_e = 20;
    cout << "\nDomain of e: [" << -p_input.L_e << ", +" << p_input.L_e << "]";
    p_input.N_q = 1000;
